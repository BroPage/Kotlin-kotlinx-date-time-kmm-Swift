...
/*
    ************************************************************************************************
    *   class:      DataStore (expect common)
    *   inherits:   none
    *
    *   Description: This is the common point where the data acquired in this common routine is passed
    *                to the both the applications. There is a matching implementation in the androidMain
    *                and iosMain that does exactly the same thing as this module. This would be the
